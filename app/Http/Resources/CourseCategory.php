...
class CourseCategory extends Resource
{
    ...
    public function toArray($request)
    {
        ...
        $hospital_courses_data = DB::table("courses")
            ...
            ->having('is_course','>','0')
            ->groupBy("courses.id")->limit(1)->get();
        ...
        $response = [
			...
			'short_description' => (!empty($user_data[0]->language_id) || $user_data[0]->language_id == 1) ? strip_tags($this->description) : strip_tags($this->spanish_description),
            'certificate_requirement' => $this->certificate_requirement,
            'certificate_confirmation' => $this->certificate_confirmation,
