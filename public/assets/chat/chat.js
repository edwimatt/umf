...
(function() {
    ...
    $(document).on('click','.search_user',function(){
        ...
        $('#active_chat_user_name').html('Chat is loading....<hr />');
        //check room
        let get_room_param = {
            user_id: currentUser.id,
        ...
        socket.emit('_getRoomId',get_room_param).on('_getRoomId',(data) => {

            let chat_room_id = data.data.chat_room_id;
            $('#active_chat_user_name').html(target_username + '<hr/>');
    ...
    $(document).on('click','._load_chat',function(){
        ...
        let chat_username   = $(this).find('#chat_username').html();

        $('#active_chat_user_name').html(chat_username + '<hr/>');
        $('.chat-box').attr('data-receiver',target_user_id)
        $('.chat-box').attr('data-roomId',chat_room_id);
    ...
    autoComplete('.autocomplete',base_url + '/user/suggestions');
