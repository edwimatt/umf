...
<div class="right_col" role="main">
   <div class="panel panel-default">
      <form autocomplete="off" enctype="multipart/form-data" method="post" action="{{url('/user/editpostphysician')}}" accept-charset="UTF-8">
         ...
         <div class="panel-body">
            ...
            <div class="form-group">
               ...
               <?PHP
                  ...
                  ?>
               <input type="text" class="form-control" id="first_name" maxlength="30" name="first_name" placeholder="First name" value="<?PHP echo $first_name ?>" />
            </div>
            <div class="form-group">
               ...
               <?PHP
                  ...
                  ?>
               <input type="text" class="form-control" id="last_name" maxlength="30" name="last_name" placeholder="Last name" value="<?PHP echo $last_name ?>" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <?PHP
                  ...
                  ?>
               <input type="text" class="form-control" id="mobile_no" maxlength="30" name="mobile_no" placeholder="Mobile No" value="<?PHP echo $mobile_no ?>" />
            </div>
               ...
               <div class="form-group">
                  ...
                  @if($post_data['image_url'] != '')
                     <img width="200px" src="<?PHP echo URL::to('uploads/user/'.$post_data['image_url']) ?>" alt="">
                  @endif
               </div>
