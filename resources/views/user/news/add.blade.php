...
<div class="right_col" role="main">
    <div class="row" id="content-heading">
        <form autocomplete="off" enctype="multipart/form-data" method="post"
              action="{{url('/user/hospital-news/add')}}"
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="30" class="form-control" id="news_title" name="news_title"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" maxlength="30" class="form-control" id="news_image" name="news_image"
                               value="{!! old("news_image") !!}"/>
                    </div>

                    <div class="form-group">
                        <label for="title">News Description</label>
